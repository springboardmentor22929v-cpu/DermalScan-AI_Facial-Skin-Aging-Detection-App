# File: scripts/train_model.py (MODIFIED to remove augmentation layers from model)
...
# Data comes in already augmented and normalized now
...
LOCAL_WEIGHTS_PATH = os.path.join(MODELS_DIR, 'efficientnetb0_base_notop.weights.h5') # <--- Ensure this is correct

# Load pretrained EfficientNetB0
base_model = EfficientNetB0(
    weights=LOCAL_WEIGHTS_PATH,
    include_top=False,
    input_shape=(IMG_SIZE, IMG_SIZE, 3), # Model now receives pre-augmented and normalized data
...
# No augmentation or normalization layers here anymore
