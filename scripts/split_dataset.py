# File: scripts/split_dataset.py (MODIFIED for new Augmentation Output)
...
# --- Configuration ---
# Input directory for all augmented images (output of the new augment_dataset.py)
INPUT_DIR = r"C:\Users\dhana\OneDrive\Desktop\dermalscan-project\data_augmented_fixed" # <--- VERIFY THIS PATH
# Base output directory for the split datasets
OUTPUT_BASE_DIR = r"C:\Users\dhana\OneDrive\Desktop\dermalscan-project\data_split_fixed" # <--- VERIFY THIS PATH
