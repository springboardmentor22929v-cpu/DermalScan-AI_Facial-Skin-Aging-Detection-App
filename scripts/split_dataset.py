...
INPUT_DIR = r"C:\Users\dhana\OneDrive\Desktop\dermalscan-project\data_augmented" # <--- CHANGED THIS LINE
OUTPUT_BASE_DIR = r"C:\Users\dhana\OneDrive\Desktop\dermalscan-project\data_split" # <--- CHANGED THIS LINE (Back to original)
# Split ratios
TRAIN_RATIO = 0.70
VAL_RATIO = 0.15
TEST_RATIO = 0.15
